...
model {
  ...
  sigmaInt ~ exponential(1);      //T-vector of stdevs from mean of each intercept
...
generated quantities {
  ...
  Cov_a = diag_pre_multiply(sigmaInt, L_R_a) * diag_pre_multiply(sigmaInt, L_R_a)';       //construct cov matrix from cholesky factors of cov matrix to look at in output
