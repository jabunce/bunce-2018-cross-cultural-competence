...
props_o <- data.frame(
  ...
  Mest=table( d$question[which(d$Machi==0 & d$target.num==3)], d$response.e[which(d$Machi==0 & d$target.num==3)] )[,2] /
    rowSums( table( d$question[which(d$Machi==0 & d$target.num==3)], d$response.e[which(d$Machi==0 & d$target.num==3)]) )
)
